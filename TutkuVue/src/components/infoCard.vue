...
<v-card>
    <v-img
      ...
      cover
    >
      <v-card-title  class="text-white text-h4 border-bottom border-success " >VOLEYBOL OKULU</v-card-title>
      <v-divider
        :thickness="6"
      ...
      <v-spacer />
      <VBtn color="success">Daha Fazla Bilgi</VBtn>
    </v-img>
...
import image from '@/assets/brightnesback.jpg'
</script>
